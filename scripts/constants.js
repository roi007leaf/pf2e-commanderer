export const MODULE_ID = "pf2e-commanderer";
export const SOCKET_NAME = `module.${MODULE_ID}`;
export const FLAG_SCOPE = MODULE_ID;

export const SYSTEM_EFFECTS = Object.freeze({
  mountaineeringTraining: "Compendium.pf2e.feat-effects.Item.IPznWmsoaoT2zhgU",
  navalTraining: "Compendium.pf2e.feat-effects.Item.LCU3Lv6ojuTl4DSY",
  demoralizingCharge: "Compendium.pf2e.feat-effects.Item.91qBP1n04xsKeXkE",
  biggerTheyAre: "Compendium.pf2e.feat-effects.Item.9Kjnwzu3DWs5U7NH",
  mirroredWall: "Compendium.pf2e.feat-effects.Item.IIjE6NOYpOfRuCBR",
  sanguineRevitalization: "Compendium.pf2e.feat-effects.Item.kJndFOHNBH8SR5IM",
});
